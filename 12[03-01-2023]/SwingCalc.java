...
public class SwingCalc extends JFrame implements ActionListener{
	...
	private JTextField tf=new JTextField("ENTER");
	tf.setBounds(100,117,201,25);
	f.add(tf);
	
	private JButton b1= new JButton("1");		//1
	...
	private JButton b5= new JButton("4");		//4
	...
	private JButton b9= new JButton("7");		//7
	...
	f.add(b15);
	private JButton b16= new JButton("C");
